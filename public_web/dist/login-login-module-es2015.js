...
let LoginPage = class LoginPage {
    constructor(router, loginService, toastrService) {
        this.router = router;
    ...
    login(position, status) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.loading = true;
            yield this.loginService.getLogin(this.usuario, this.clave).subscribe((data) => {
                console.error(data);
                this.itk = data;
                ...
                this.loading = false;
                this.isHidden = false;
                this.toastrService.show(status || 'Success', `Error al acceder a los datos de conexion`, { position, status });
            });
        });
    }
    PresionarEnter(e) {
